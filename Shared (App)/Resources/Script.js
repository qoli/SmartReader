function show(platform, enabled, useSettingsInsteadOfPreferences) {
  ...
  if (useSettingsInsteadOfPreferences) {
    document.getElementsByClassName("platform-mac state-on")[0].innerText =
      "SmartReader’s extension is currently on. You can turn it off in the Extensions section of Safari Settings.";
    document.getElementsByClassName("platform-mac state-off")[0].innerText =
      "SmartReader’s extension is currently off. You can turn it on in the Extensions section of Safari Settings.";
    document.getElementsByClassName("platform-mac state-unknown")[0].innerText =
      "You can turn on SmartReader’s extension in the Extensions section of Safari Settings.";
...
document
  ...
  .addEventListener("click", function () {
    webkit.messageHandlers.controller.postMessage("sendNativeMessage");
  });
